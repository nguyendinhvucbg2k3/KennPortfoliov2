...
export default function EditorProjectPage() {
  ...
  const pageContent = content[language].editorDetail;

  const project = editorProjects.find(p => p.slug === slug || p.id === slug);
